...
class BaseParticleEmitter_3 : public ParticleEmitter
{
public:
	BaseParticleEmitter_3();
	~BaseParticleEmitter_3();
...
private:
	...
	GLuint particleColourSSBO;
	GLuint particleSizeSSBO;
	GLuint particleVelocitySSBO;
	GLuint particleLifetimeSBBO;
	GLuint particleMaxLifetimeSSBO;
